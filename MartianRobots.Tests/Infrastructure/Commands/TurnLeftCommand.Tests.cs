...
namespace MartianRobots.Tests.Infrastructure.Commands
{
    ...
    {
        /// <summary>
        /// Test: IgnoreIfRobotIsLost A robot that moves off an edge of the grid is lost forever.
        /// However, lost robots leave a robot scent that prohibits future robots from dropping off the 
        /// world at the same grid point.
        ...
        public void IgnoreIfRobotIsLost()
        {
            ...
            TurnLeftCommand.Instance.ExecuteCommand(robot, map.Object);
        ...
        public void MoveRobot()
        {
            ...
            map.Verify(mock => mock.TurnLeft(It.IsAny<OrientationEnum>()), Times.Once());
        }
    }
}
